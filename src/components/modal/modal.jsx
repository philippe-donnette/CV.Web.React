...
class Modal extends Component {
    render() {
        return (
            <div id={this.props.modalId} className="panel-default modal fade" role="dialog">
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="panel-heading dn-modal-heading">
                            <div className="row">
                                <div className="col-lg-1 col-md-1 col-sm-1 col-xs-3 pull-right">
                                    <a className="btn btn-default dn-btn-close" data-dismiss="modal"><i className="fa fa-close"></i></a>
                                </div>
