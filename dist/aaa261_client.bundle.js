...
let projectActions = {
    getProjectsFromData: function (projects) {
        return {
            type: 'GET_PROJECTS',
            projects: projects
        }
    },
    getProjectsFromApi: function (config) {
        ...
        projectService.getProjects()
            ...
            .then((data) => {
                dispatch(__WEBPACK_IMPORTED_MODULE_1__index__["default"].getProjectsFromData(data));
            })
            .catch((error) => { throw (error); });
    },
    getProjects: function () {
        return (dispatch, getState) => {
            const { config } = getState().settings; // dispatch(actions.getSettings());
            dispatch(__WEBPACK_IMPORTED_MODULE_1__index__["default"].getProjectsFromApi(config));
        };
    }
}
...
//# sourceMappingURL=aaa261_client.bundle.js.map