...
let projectActions = {
    ...
    getProjects: function () {
        return (dispatch, getState) => {
            const { settings } = dispatch(__WEBPACK_IMPORTED_MODULE_1__index__["default"].getSettings());
            ...
            projectService.getProjects()
                ...
                .then((data) => {
                    dispatch(__WEBPACK_IMPORTED_MODULE_1__index__["default"].getProjects(data));
                })
                .catch((error) => { throw (error); });;    
        };
    }
...
//# sourceMappingURL=a904fb_client.bundle.js.map