...
/* harmony default export */ __webpack_exports__["default"] = (ProjectService);
...
var _projectService = __webpack_require__(152);
...
let projectActions = {
    getProjects: function () {
        return (getState) => {
            let projectService = new ProjectService(getState().settings.apiBaseURI);
            projectService.getProjects()
                .then((response) => {
                    return response.json();
                })
...
//# sourceMappingURL=8e442e_client.bundle.js.map