...
let projectActions = {
    getProjects: function () {
        return (getState) => {
            let projectService = new __WEBPACK_IMPORTED_MODULE_0__services_project_service__["a" /* default */](getState().settings.apiBaseURI);
            projectService.getProjects()
                .then((response) => {
                    return response.json();
                })
...
//# sourceMappingURL=43fe1c_client.bundle.js.map